...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-[100vh] max-md:h-[100vh] my-[70px] flex justify-center items-center p-2' >
        <form method='POST' action="https://getform.io/f/f9df8275-1076-4cec-9d58-e30b740a5d2e" className='flex flex-col max-w-[700px] w-full'>
            <div className='pb-2'>
                <h2>Contact</h2>
                <p className='text-2xl'>Please let me know if you have any questions or suggestions:</p>
            </div>
